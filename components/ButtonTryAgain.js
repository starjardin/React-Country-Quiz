				...
				<p>
					{score != 0 &&
						`Here is your reward : ${score} ${
							score > 1 ? ' slices of pizzas' : 'slice of pizza'
						} ${pizzas.repeat(score)}`}
				</p>
				<p>
					{score > 5 &&
						score <= 10 &&
						"Good score . Why don't you try again, you'll get higher score"}
				</p>
				<p>
					{score > 10 && score <= 15 && 'Amazing! You are a good candidate'}
				</p>
				<p>
					{score > 15 && score < 250 && 'Amazing! You beat the best players'}
				</p>
				<p>
					{score > 250 &&
						'Congratulations! You know about all of the countries'}
				</p>
				<Link to='/'>
